      ...
      <div className="w-full max-w-md rounded-2xl bg-white/10 p-10 text-center shadow-2xl backdrop-blur-lg border border-white/20">
        ...
        {error === 'not_admin' && (
          <div className="mb-6 rounded-lg bg-red-500/20 border border-red-500/50 p-4 text-sm text-red-200">
            Access denied. You must be a superadmin to access this area.
          </div>
        )}

        <button
          onClick={handleSignIn}
          className="w-full rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-purple-100 transition shadow-lg"
        >
          Sign in with Google
        </button>
